...
const BTN_SEC: React.CSSProperties = { ...BTN, background: 'var(--bg-card)', color: 'var(--text)', border: '1px solid var(--border)' }
              ...
              {(['', 'expense', 'income', 'transfer'] as const).map((t) => (
                <button
                  ...
                  style={{
                    ...
                    background: filters.type === t ? 'var(--accent)' : 'var(--bg-card)',
          ...
          <div key={tx.id}>
            ...
            <div
              style={{
                ...
                padding: '10px 16px',
                borderBottom: i < transactions.length - 1 || editingId === tx.id ? '1px solid var(--border)' : 'none',
              }}
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', gap: '8px', marginTop: '2px', flexWrap: 'wrap' }}>
                  <span style={{ color: 'var(--text-muted)', fontSize: '12px' }}>{formatDt(tx.datetime)}</span>
                  {tx.type === 'transfer'
                    ? <span style={{ color: 'var(--text-muted)', fontSize: '12px' }}>{tx.account_name} - {tx.to_account_name}</span>
                    : <>
                        <span style={{ color: 'var(--text-muted)', fontSize: '12px' }}>{tx.account_name}</span>
                        {tx.category_name && <span style={{ color: 'var(--text-muted)', fontSize: '12px' }}>{tx.category_name}</span>}
                      </>
                  }
                  {tx.note && (
                  ...
                  {(['expense', 'income', 'transfer'] as const).map((t) => (
                    <button
                      ...
                      style={{
                        ...
                        background: editForm.type === t ? typeColor(t) : 'var(--bg-card)',
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              background: selected ? '#f0b42920' : 'var(--bg-card)',
